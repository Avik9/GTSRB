...
import os
import warnings
from Data_Set_Loader import Data_Set_Loader as ImageDataset
from datetime import datetime
import matplotlib.pyplot as plt
from CNN_2_Classifier import CNN_classifier as MNISTLeNet
...
class MixtureOfExperts():
    ...
    def __init__(self, dataset: ImageDataset, num_experts=4, load_dataset=True, num_epochs=100, learning_rate=0.001,
        ...
        self.num_inputs = self.dataset.x_train_set.shape[1]
    ...
    def build_model(self, epochs=50, learning_rate=0.001,
        ...
        for x in range(self.num_experts):
            self.networks.append(MNISTLeNet(dataset=self.dataset))
...
if __name__ == "__main__":
    ...
    mnist = ImageDataset("./Training", "./Testing/")
    n_train = len(mnist.x_train_set)
    n_test = len(mnist.x_test_set)
